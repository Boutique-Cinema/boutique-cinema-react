...
export const getQuestion = async (qNum) => {
  const res = await axios.get(`${QUESTION_API_PREFIX}/${qNum}`);
...
export const getQuestionList = async (page, size) => {
  const res = await axios.get(`${QUESTION_API_PREFIX}/list`, {
    params: {
      size: size,
      page: page,
    },
...
export const registerQuestion = async (questionData) => {
  const res = await axios.post(`${QUESTION_API_PREFIX}`, questionData);
...
export const modifyQuestion = async (qNum, questionData) => {
  const res = await axios.put(`${QUESTION_API_PREFIX}/${qNum}`, questionData);
...
export const removeQuestion = async (qNum) => {
  axios.delete(`${QUESTION_API_PREFIX}/${qNum}`);
